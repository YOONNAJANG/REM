...
def main():
    ...
    parser.add_argument("--threshold_dataset_path", type=str, default="")
    parser.add_argument("--pretrained_model", type=str, default="facebook/bart-large", help="pre-trained model path among {facebook/bart-base, facebook/bart-large}")
    ...
    parser.add_argument("--dae_model", type=str, default="REM/metrics/dae_factuality/model/dae_w_syn_hallu", help="pre-trained dae model directory")
