#FoCus
#CUDA_VISIBLE_DEVICES=4 nohup python eval_refiner.py --data_type focus --pretrained_model facebook/bart-large \
...
#CMUDoG
#CUDA_VISIBLE_DEVICES=4 nohup python eval_refiner.py --data_type cmudog --pretrained_model facebook/bart-large \
...
#WoW
#CUDA_VISIBLE_DEVICES=3 nohup python eval_refiner.py --data_type wow --pretrained_model facebook/bart-large \
#--test_dataset_path /home/data/leejeongwoo/projects/focus/Refiner/baselines/wow/output/2023_emnlp/bart_base/test.json \
