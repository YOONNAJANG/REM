...
python src/train_refiner.py --ner_coef 1 --epochs 100 --data_type cmudog --output_dir ckpt_cmudog \
--train_path "/data/ssh5131/focus_modeling/for_refiner_v2/cmudog/train.json" \
--train_cache_path "/data/ssh5131/focus_modeling/for_refiner_v2/cmudog/train_cache.tar.gz" \
--dev_path "/data/ssh5131/focus_modeling/for_refiner_v2/cmudog/valid.json" \
--dev_cache_path "/data/ssh5131/focus_modeling/for_refiner_v2/cmudog/valid_cache.tar.gz"