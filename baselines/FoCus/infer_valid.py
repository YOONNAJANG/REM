...
from baselines.FoCus.data_utils import get_testdata_loaders, add_special_tokens_test, special_tokens
...
class Model(LightningModule):
    ...
    def test_epoch_end(self, outputs):
        ...
        for test_data_index, test_data in enumerate(text_result):
            ...
            pred_dict['all_persona'] = all_persona
...
def main():
    ...
    parser.add_argument("--test_dataset_path", type=str, default="/home/mnt/ssh5131/FoCus_data/our_data/valid_ours.json", help="Path or url of the dataset. If empty download from S3.")
