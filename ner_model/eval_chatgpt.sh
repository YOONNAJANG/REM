...
#focus chatgpt
###before_refine
#CUDA_VISIBLE_DEVICES=2 nohup python eval_refiner.py --data_type chatgpt --pretrained_model facebook/bart-large --mode ner --test_dataset_path /home/data/ssh5131/focus_modeling/for_refiner_v2/chatgpt/focus/chatgpt_002_test_ours_for_inference.json --test_dataset_cache /home/data/ssh5131/focus_modeling/for_refiner_v2/chatgpt/focus/ours_cache_test.tar.gz \
...
##BART-base b5
CUDA_VISIBLE_DEVICES=7 nohup python eval_refiner.py --data_type chatgpt --pretrained_model facebook/bart-base --mode ner --test_dataset_path /home/data/ssh5131/focus_modeling/for_refiner_v2/chatgpt/focus/chatgpt_002_test_ours_for_inference.json --test_dataset_cache /home/data/ssh5131/focus_modeling/for_refiner_v2/chatgpt/focus/ours_cache_test.tar.gz \
--checkpoint /home/data/yoonna/Refiner/output/ner/wo_prompt_100/epoch13-01.2539.ckpt --output_dir /home/data/yoonna/Refiner/output/ner/wo_prompt_100/ \
...
##bart-large
##before refine
#CUDA_VISIBLE_DEVICES=0 nohup python eval_refiner.py --data_type chatgpt --pretrained_model facebook/bart-large --mode ner --test_dataset_path /home/data/ssh5131/focus_modeling/for_refiner_v2/chatgpt/wow/chatgpt_pretty_test_random_split_for_inference.json --test_dataset_cache /home/data/ssh5131/focus_modeling/for_refiner_v2/chatgpt/wow/ours_cache_test.tar.gz \
...
#--checkpoint /home/data/yoonna/Refiner/output/ner/bart_large_wow_wo_prompt_100/epoch5-02.3011.ckpt --output_dir /home/data/yoonna/Refiner/output/ner/bart_large_wow_wo_prompt_100/ \
#--num_beams 1 --refine_threshold 1.0 --seed 644128 --flag bart_large_wow_chatgpt_ner_refine_b1 > eval_logs/bart_large_wow_chatgpt_ner_refine_b1.out &
...
##BART-base b5
CUDA_VISIBLE_DEVICES=6 nohup python eval_refiner.py --data_type chatgpt --pretrained_model facebook/bart-base --mode ner --test_dataset_path /home/data/ssh5131/focus_modeling/for_refiner_v2/chatgpt/wow/chatgpt_pretty_test_random_split_for_inference.json --test_dataset_cache /home/data/ssh5131/focus_modeling/for_refiner_v2/chatgpt/wow/ours_cache_test.tar.gz \
