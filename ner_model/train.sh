...
CUDA_VISIBLE_DEVICES=6 nohup python ner_model/train_refiner.py --ner_coef 0.5 --epochs 100 --data_type focus --output_dir /home/data/yoonna/Refiner/output/ner/w_prompt_100 > logs/w_prompt_100.log &
