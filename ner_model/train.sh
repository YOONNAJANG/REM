...
CUDA_VISIBLE_DEVICES=1 python ner_model/train_refiner.py --ner_coef 0.5 --epochs 1 --data_type focus --output_dir /home/data/yoonna/Refiner/output/regen_add_ner/gen1_ner0.5_ptuning --ptuning True
