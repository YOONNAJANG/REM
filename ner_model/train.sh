...
#CUDA_VISIBLE_DEVICES=2 nohup python ner_model/train_refiner.py --ner_coef 0.5 --epochs 100 --data_type focus --output_dir /home/data/ssh5131/focus_modeling/regen_add_ner/gen1_ner0.5_E100_metric_weighted > nohup_gen1_ner0.5_E100_metric_weighted &
