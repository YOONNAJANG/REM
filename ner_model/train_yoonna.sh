...
#BART base ner wow
CUDA_VISIBLE_DEVICES=1 nohup python train_refiner.py --ner_coef 0.7 --epochs 100 --lr 6.25e-5 --data_type wow --mode ner --output_dir /home/data/yoonna/Refiner/output/ner/wow_wo_prompt_100 > logs/wow_wo_prompt_100.log &
...
###BART large ner wow
#CUDA_VISIBLE_DEVICES=4 nohup python train_refiner.py --ner_coef 0.7 --epochs 100 --pretrained_model facebook/bart-large --data_type wow --train_batch_size 8 --grad_accum 32 --lr 6.25e-5 --mode ner --output_dir /home/data/yoonna/Refiner/output/ner/bart_large_wow_wo_prompt_100 > logs/bart_large_wow_wo_prompt_100.log &
