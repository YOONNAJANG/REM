...
#CUDA_VISIBLE_DEVICES=1 nohup python train_refiner.py --ner_coef 0.5 --epochs 100 --pretrained_model facebook/bart-large --data_type focus --lr 6.25e-5 --mode ner --output_dir /home/data/yoonna/Refiner/output/ner/bart_large_wo_prompt_100 > logs/bart_large_wo_prompt_100.log &
##BART large ner wow
#CUDA_VISIBLE_DEVICES=2 nohup python train_refiner.py --ner_coef 0.5 --epochs 100 --pretrained_model facebook/bart-large --data_type wow --lr 6.25e-5 --mode ner --output_dir /home/data/yoonna/Refiner/output/ner/bart_large_wow_wo_prompt_100 > logs/bart_large_wow_wo_prompt_100.log &
##BART large ner cmudog
#CUDA_VISIBLE_DEVICES=3 nohup python train_refiner.py --ner_coef 0.5 --epochs 100 --pretrained_model facebook/bart-large --data_type cmudog --lr 6.25e-5 --mode ner --output_dir /home/data/yoonna/Refiner/output/ner/bart_large_cmudog_wo_prompt_100 > logs/bart_large_cmudog_wo_prompt_100.log &
...
##ner wow
#CUDA_VISIBLE_DEVICES=4 nohup python train_refiner.py --ner_coef 0.5 --epochs 100 --pretrained_model t5-small --data_type wow --mode ner --output_dir /home/data/yoonna/Refiner/output/ner/t5_wow_wo_prompt_100 > logs/t5_wow_wo_prompt_100.log &
##ner cmudog
#CUDA_VISIBLE_DEVICES=6 nohup python train_refiner.py --ner_coef 0.5 --epochs 100 --pretrained_model t5-small --data_type cmudog --mode ner --output_dir /home/data/yoonna/Refiner/output/ner/t5_cmudog_wo_prompt_100 > logs/t5_cmudog_wo_prompt_100.log &

##T5 ner focus desc
#CUDA_VISIBLE_DEVICES=0 nohup python train_refiner.py --ner_coef 0.5 --epochs 100 --pretrained_model t5-base --lr 1e-4 --data_type focus --mode ner --output_dir /home/data/yoonna/Refiner/output/ner/t5_wo_prompt_100 > logs/t5_wo_prompt_100.log &
##ner wow descrun
#CUDA_VISIBLE_DEVICES=6 nohup python train_refiner.py --ner_coef 0.5 --epochs 100 --pretrained_model t5-base --lr 1e-4 --data_type wow --mode ner --output_dir /home/data/yoonna/Refiner/output/ner/t5_wow_wo_prompt_100 > logs/t5_wow_wo_prompt_100.log &
#ner cmudog desc
#CUDA_VISIBLE_DEVICES=7 nohup python train_refiner.py --ner_coef 0.5 --epochs 100 --pretrained_model t5-base --lr 1e-4 --data_type cmudog --train_batch_size 8 --grad_accum 32 --mode ner --output_dir /home/data/yoonna/Refiner/output/ner/t5_cmudog_wo_prompt_100 > logs/t5_cmudog_wo_prompt_100.log &

##T5 ner focus desc large
CUDA_VISIBLE_DEVICES=3 nohup python train_refiner.py --ner_coef 0.5 --epochs 100 --pretrained_model t5-large --lr 1e-5 --data_type focus --train_batch_size 8 --grad_accum 32 --mode ner --output_dir /home/data/yoonna/Refiner/output/ner/t5_large_wo_prompt_100 > logs/t5_large_wo_prompt_100.log &
##ner wow desc
CUDA_VISIBLE_DEVICES=4 nohup python train_refiner.py --ner_coef 0.5 --epochs 100 --pretrained_model t5-large --lr 1e-5 --data_type wow --mode ner --output_dir /home/data/yoonna/Refiner/output/ner/t5_large_wow_wo_prompt_100 > logs/t5_large_wow_wo_prompt_100.log &
##ner cmudog desc
CUDA_VISIBLE_DEVICES=5 nohup python train_refiner.py --ner_coef 0.5 --epochs 100 --pretrained_model t5-large --lr 1e-5 --data_type cmudog --train_batch_size 4 --grad_accum 64 --mode ner --output_dir /home/data/yoonna/Refiner/output/ner/t5_large_cmudog_wo_prompt_100 > logs/t5_large_cmudog_wo_prompt_100.log &
