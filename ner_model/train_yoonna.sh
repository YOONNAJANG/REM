...
#fewshot 500
CUDA_VISIBLE_DEVICES=7 nohup python train_refiner.py --ner_coef 0.5 --epochs 1 --data_type focus --mode gen --checkpoint /home/data/yoonna/Refiner/output/ner/wo_prompt_100/epoch15-valid_lm_loss1.4855.ckpt --output_dir /home/data/yoonna/Refiner/output/gen/wo_prompt_1_100shot --fewshot True --fewnum 100 > logs/gen_wo_prompt_1_100shot.log &
...
CUDA_VISIBLE_DEVICES=5 nohup python train_refiner.py --ner_coef 0.5 --epochs 1 --data_type focus --mode gen --checkpoint /home/data/yoonna/Refiner/output/ner/w_prompt_keyword_100/epoch22-valid_lm_loss1.9821.ckpt --output_dir /home/data/yoonna/Refiner/output/gen/w_prompt_keyword_1_100shot --ptuning True --fewshot True --fewnum 100 --target_word_to_init keyword > logs/gen_w_prompt_keyword_1_100shot.log &
CUDA_VISIBLE_DEVICES=3 nohup python train_refiner.py --ner_coef 0.5 --epochs 1 --data_type focus --mode gen --checkpoint /home/data/yoonna/Refiner/output/ner/w_prompt_entity_100/epoch9-valid_lm_loss2.0814.ckpt --output_dir /home/data/yoonna/Refiner/output/gen/w_prompt_entity_1_100shot --ptuning True --fewshot True --fewnum 100 --target_word_to_init keyword > logs/gen_w_prompt_entity_1_100shot.log &
