...
path = "/home/data/ssh5131/focus_modeling/eval_output/chatgpt/focus"
...
for file_name in file_list:
    ...
    key = ['chrF++', 'rouge1', 'rouge2', 'rougeL', 'bleu', 'ppl', 'ner_acc','ner_f1', 'ec','tc', 'dae_result', 'dist1_result', 'dist2_result']
    data = []
    for k in key:
