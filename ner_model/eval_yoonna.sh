...
###T5 base ner focus
##b10
#CUDA_VISIBLE_DEVICES=4 nohup python eval_refiner.py --data_type focus --pretrained_model t5-base --mode ner --test_dataset_path /home/data/ssh5131/focus_modeling/for_refiner_v2/focus/test.json --test_dataset_cache /home/data/ssh5131/focus_modeling/for_refiner_v2/focus/ours_cache_test.tar.gz \
#--checkpoint /home/data/yoonna/Refiner/output/ner/t5_wo_prompt_100/epoch99-valid_lm_loss4.6940.ckpt --output_dir /home/data/yoonna/Refiner/output/ner/t5_wo_prompt_100/ \
